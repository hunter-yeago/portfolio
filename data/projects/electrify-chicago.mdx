...
<Section id="my-contributions">
  ...
  <Paragraph>
    I am currently working on this <SectionLink text=" Citywide Stats Page Github Pull Request" link="https://github.com/vkoves/electrify-chicago/pull/192" />,
    which will give a year over year analysis of the greenhouse gas emissions and other statistics for all of the buildings we have data for. I used Pandas to
    take our existing data and organize it by year, pass that data to Vue and render out the information with D3.
  </Paragraph>
  <Paragraph>Here are a couple of examples of the charts interactive charts I've created for it:</Paragraph>
  <CityWideStats />
</Section>
...
<Section id="technical-details">
  ...
  <Paragraph>
    The frontend is built in VueJS, and uses a Jamstack framework called Gridsome. Data is collected from the{" "}
    <SectionLink text="Chicago Data Portal" link="https://data.cityofchicago.org/" /> and is sent through a Python / Pandas data pipeline.
  </Paragraph>
</Section>
