...
export default function GithubIconLink() {
  return (
    <a href="https://github.com/hunter-yeago" target="_blank" aria-label="Go to my GitHub page - opens in a new tab">
      <svg
        className="p-1 w-11 h-11 stroke-black hover:cursor-pointer stroke-[0.5] stroke-primary-50 ceva hover:stroke-accent-400"
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" strokeLinecap="round" strokeLinejoin="round"></path>
        <path
