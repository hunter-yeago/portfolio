    ...
    <div className=" mx-auto bg-white p-4 rounded border-2 shadow min-h-[20rem]">
        ...
        md-custom:flex-row">
            ...
            <div className="p-4 flex flex-col gap-4">
                ...
                <p className="text-gray-700"> I went to PHP[TEK] 2024, and here's my article about it , and here's my article about it! , and here's my article about it! , and here's my article about it!</p>
                <a className='w-40 text-center bg-gray-800 text-white p-2 rounded-md hover:bg-yellow-600' href="https://www.linkedin.com/in/hunter-yeago/" target="_blank" rel="noopener noreferrer" aria-label="View my LinkedIn - opens in a new tab">Read Article</a>
            </div>
