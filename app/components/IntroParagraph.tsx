        ...
        <section className='flex flex-col items-center'>
            ...
            md-custom:grid-cols-[70%,30%]'>
                ...
                <div className="flex flex-col justify-center gap-4 pr-4">
                    ...
                    <p className="max-w-3xl"> I specialize in creating tools that are user-friendly, simple, and delightful. As a web developer at Lettuce Entertain You, Chicago's <span id="70websites">largest</span> restaurant company, I manage and create new websites for over 70+ properties, ensuring each one is optimized for performance and user experience.</p>
                    ...
                    md-custom:justify-start'>
                        <span id="linkedin" className='flex'>
                            <a className='w-40 text-center bg-gray-800 text-white p-2 rounded-md hover:bg-yellow-600' href="https://www.linkedin.com/in/hunter-yeago/" target="_blank" rel="noopener noreferrer" aria-label="View my LinkedIn - opens in a new tab">View LinkedIn</a></span>
                            <a className='w-40 text-center bg-white text-black border border-gray-800 p-2 rounded-md hover:bg-yellow-600' href="https://github.com/hyradar" target="_blank" rel="noopener noreferrer" aria-label="View my Github - opens in a new tab">View Github</a>
                    </div>
                </div>
