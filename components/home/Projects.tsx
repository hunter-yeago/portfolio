...
export default function ProjectPreview() {
  ...
  return (
    <section className="flex flex-col px-4 md:px-16 py-12 gap-4 pt-12 bg-gray-50 justify-center items-center scroll-mt-36" id="projects">
      <div className="max-w-[1200px]">
        <h2 className="text-3xl text-center font-bold mb-4">Development Experience</h2>
