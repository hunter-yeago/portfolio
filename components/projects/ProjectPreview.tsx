...
export default function ProjectPreview({ project }: Props) {
  return (
    <Link
      className="p-6 border-4 cursor-pointer focus:border-gray-800 focus:outline-none flex gap-14 justify-between rounded-xl shadow-lg hover:border-gray-800 hover:shadow-xl"
